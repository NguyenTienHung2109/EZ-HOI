...
CHECKPOINT_PATH=" /data/hpc/hung/EZ-HOI/checkpoints/hico_HO_pt_default_vitbase/ckpt_426660_12.pt"
CLIP_MODEL_PATH="/data/hpc/hung/EZ-HOI/checkpoints/pretrained_CLIP/ViT-B-16.pt"
