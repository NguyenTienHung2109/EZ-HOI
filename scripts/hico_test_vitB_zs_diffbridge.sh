#!/bin/bash
# HICO-DET testing with ViT-B/16 + Diffusion Bridge on HOI ROI Features
# Zero-shot unseen verb setting
#
# Usage: Update the --resume path to point to your trained checkpoint
# Example: --resume checkpoints/hico_HO_pt_default_vitbase_diffbridge/checkpoint_best.pth
